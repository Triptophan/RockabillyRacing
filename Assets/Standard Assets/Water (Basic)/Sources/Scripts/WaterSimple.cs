...
public class WaterSimple : MonoBehaviour
{
	void Update()
	{
		...
		Vector4 offsetClamped = new Vector4(Mathf.Repeat(offset4.x,1f), Mathf.Repeat(offset4.y,1f), Mathf.Repeat(offset4.z,1f), Mathf.Repeat(offset4.w,1f));
		mat.SetVector( "_WaveOffset", offsetClamped );
		
		Vector3 scale = new Vector3( 1f/waveScale, 1f/waveScale, 1 );
